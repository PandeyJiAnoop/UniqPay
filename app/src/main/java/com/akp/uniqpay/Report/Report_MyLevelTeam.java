...
public class Report_MyLevelTeam extends AppCompatActivity {
    ImageView menuImg;
    String UserId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_my_level_team);
        FindId();

        srl_refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                if (NetworkConnectionHelper.isOnline(Report_MyLevelTeam.this)) {
                    ...
                    Toast.makeText(Report_MyLevelTeam.this, "Please check your internet connection! try again...", Toast.LENGTH_SHORT).show();
                }
            }
        });
        TopupDetails("",UserId);
...
//                        String language = getDetails.getString("CustomerAccountId");
                    ...
                    GridLayoutManager gridLayoutManager = new GridLayoutManager(Report_MyLevelTeam.this, 1);
                    MyTeamAdapter walletHistoryAdapter = new MyTeamAdapter(Report_MyLevelTeam.this, arrayList);
        ...
        }, Report_MyLevelTeam.this, call1, "", true);
    }
