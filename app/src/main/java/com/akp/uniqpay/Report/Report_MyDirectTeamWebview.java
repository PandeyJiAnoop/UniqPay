...
public class Report_MyDirectTeamWebview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_my_direct_team_webview);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(Report_MyDirectTeamWebview.this.getPackageManager()) != null) {
            ...
            //REMOTE RESOURCE
            mWebView.loadUrl("https://uniqpay.in/App/DirectTeam?CustomerId="+UserId);
        }
