...
public class Web_clubdesignation extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ImageView menuImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_clubdesignation);
