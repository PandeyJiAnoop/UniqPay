...
public class LevelTreeWebview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuImg = findViewById(R.id.back_img);
        ...
        if (wifi.isConnected())
        {
            ...
            mWebView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onShowFileChooser(
                    ...
                    if (takePictureIntent.resolveActivity(LevelTreeWebview.this.getPackageManager()) != null) {
            ...
            //REMOTE RESOURCE
            mWebView.loadUrl("http://uniqpay.in/GenerationTreeWeb.aspx?UserId="+UserId);
        }
