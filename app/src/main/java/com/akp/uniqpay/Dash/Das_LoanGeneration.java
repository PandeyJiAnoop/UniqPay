...
public class Das_LoanGeneration extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_das_loan_generation);
    ...
    public void LoangenerationSubmitAPI( String UserId, String address,String customer_type,
        ...
        String otp1 = new GlobalAppApis().GeneratePersonalLoanLeadAPI(UserId,address,customer_type,email,landMark,mobile_no,
                monthly_income,name,pinCode,state);
        ApiService client1 = getApiClient_ByPost();
        Call<String> call1 = client1.getGeneratePersonalLoanLead(otp1);
...
//                            JSONObject jsonObject1 = jsonArrayr.getJSONObject(i);
                            AlertDialog.Builder builder = new AlertDialog.Builder(Das_LoanGeneration.this);
...
//                        }
                    ...
                    e.printStackTrace();
                } } }, Das_LoanGeneration.this, call1, "", true);
    }
